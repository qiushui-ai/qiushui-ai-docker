import{Q as s,a8 as p,z as x,r as g,j as e,a9 as m,Y as n,a6 as v,aa as f,ab as u,ac as j,w as y}from"./index-QCM3tg6T.js";import{M as k}from"./main-BjTc0OpD.js";import{S as N,a as M,b as S,c as b,d as w}from"./select-Gd6X59OL.js";import"./index-CZ42OGo5.js";import"./chevron-down-BGPTkRL1.js";/**
 ...
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */var V=s("outline","user","IconUser",[["path",{d:"M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0",key:"svg-0"}],["path",{d:"M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2",key:"svg-1"}]]);function A({className:i,items:t,...l}){const{pathname:c}=p(),r=x(),[o,h]=g.useState(c??"/settings"),d=a=>{h(a),r({to:a})};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"p-1 md:hidden",children:e.jsxs(N,{value:o,onValueChange:d,children:[e.jsx(M,{className:"h-12 sm:w-48",children:e.jsx(S,{placeholder:"Theme"})}),e.jsx(b,{children:t.map(a=>e.jsx(w,{value:a.href,children:e.jsxs("div",{className:"flex gap-x-4 px-2 py-1",children:[e.jsx("span",{className:"scale-125",children:a.icon}),e.jsx("span",{className:"text-md",children:a.title})]})},a.href))})]})}),e.jsx(m,{orientation:"horizontal",type:"always",className:"hidden w-full bg-background px-1 py-2 md:block min-w-40",children:e.jsx("nav",{className:n("flex py-1 space-x-2 lg:flex-col lg:space-x-0 lg:space-y-1",i),...l,children:t.map(a=>e.jsxs(v,{to:a.href,className:n(f({variant:"ghost"}),c===a.href?"bg-muted hover:bg-muted":"hover:bg-transparent hover:underline","justify-start"),children:[e.jsx("span",{className:"mr-2",children:a.icon}),a.title]},a.href))})})]})}function F(){return e.jsx(e.Fragment,{children:e.jsxs(k,{fixed:!0,children:[e.jsx("div",{className:"space-y-0.5",children:e.jsx("h1",{className:"text-2xl font-bold tracking-tight md:text-3xl",children:"Settings"})}),e.jsx(u,{className:"my-4 lg:my-6"}),e.jsxs("div",{className:"flex flex-1 flex-col space-y-2 md:space-y-2 overflow-hidden lg:flex-row lg:space-x-12 lg:space-y-0",children:[e.jsx("aside",{className:"top-0 lg:sticky lg:w-1/5",children:e.jsx(A,{items:L})}),e.jsx("div",{className:"flex w-full p-1 pr-4 overflow-y-hidden",children:e.jsx(j,{})})]})]})})}const L=[{title:"Profile",icon:e.jsx(V,{size:18}),href:"/settings"},{title:"Account",icon:e.jsx(R,{size:18}),href:"/settings/account"},{title:"Appearance",icon:e.jsx(C,{size:18}),href:"/settings/appearance"},{title:"Notifications",icon:e.jsx(z,{size:18}),href:"/settings/notifications"},{title:"Display",icon:e.jsx(I,{size:18}),href:"/settings/display"}],D=y("/_authenticated/settings")({component:F});export{D as Route};
