...
class DatabaseManager:
    ...
    def __init__(self):
        ...
        self._store_cm = None
        # 优先使用 DATABASE_URL 环境变量，否则从配置类生成
        self._database_url = os.getenv("DATABASE_URL") or database_config.url
    ...
    async def initialize(self):
        ...
        # Reset LangGraph components (they will be lazily created when needed)
